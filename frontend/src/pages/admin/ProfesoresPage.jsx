...
const ProfesoresPage = () => {
  ...
  const fetchBloqueos = async (profesorId) => {
    ...
    try {
      const res = await apiInstance.get(`padel/profesores/${profesorId}/bloqueos/`);
  ...
  const handleForzarCancelacionReservados = async () => {
    ...
    try {
      await apiInstance.post(
        `padel/profesores/${editingId}/forzar_cancelacion_reservados/`,
  ...
  const handleAgregarBloqueo = async () => {
    ...
    try {
      ...
      const res = await apiInstance.post(
        `padel/profesores/${editingId}/bloqueos/`,
        body
      );
  ...
  useEffect(() => {
    ...
    apiInstance.get("padel/profesores/")
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingId) {
        await apiInstance.put(`padel/profesores/${editingId}/`, data);
        toast.success("Profesor actualizado");
      } else {
        await apiInstance.post("padel/profesores/", data);
  ...
  const handleDelete = async (id, nombre) => {
    ...
    const apiInstance = axiosAuth(accessToken);
    try {
      await apiInstance.delete(`padel/profesores/${id}/`);
