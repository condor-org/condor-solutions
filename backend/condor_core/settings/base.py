...
# Log requests and responses when this flag is enabled. Defaults to DEBUG.
DEBUG_LOG_REQUESTS = os.environ.get('DEBUG_LOG_REQUESTS', str(DEBUG)) == 'True'
...
MIDDLEWARE = [
    ...
    'apps.common.middleware.DebugLoggingMiddleware',
