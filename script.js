...
if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
        ...
        const mailtoLink = `mailto:contacto@cnd-ia.com?subject=${subject}&body=${body}`;
        
        // Abrir el cliente de email
        window.location.href = mailtoLink;
        
        // Mostrar mensaje de confirmación
        alert('Redirigiendo a tu cliente de email. Si no se abre automáticamente, envía un email a contacto@cnd-ia.com');
